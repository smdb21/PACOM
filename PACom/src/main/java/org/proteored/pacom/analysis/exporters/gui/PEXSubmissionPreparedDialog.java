...
public class PEXSubmissionPreparedDialog extends javax.swing.JDialog {
	...
	public PEXSubmissionPreparedDialog(JDialog parent, boolean modal, File outputFolder) {
		super(parent);
		initComponents();
		...
		this.jButtonOpenOutputFolder.setIcon(ImageManager.getImageIcon(ImageManager.FOLDER));
	}
	...
	private void initComponents() {
		...
		jLabel1.setText(
				"<html>Your data is now ready for a ProteomeXchange submission.<br><br>\nClick on <b>'Open output folder'</b> button so open it on your system.<br><br>\nClick on <b>'ProteomeXchange'</b> button to go to the ProteomeXchange<br>Bulk Submission page.<br>\nFollow instructions there using the data in the output folder.\n</html>");
		jLabel1.setVerticalAlignment(javax.swing.SwingConstants.TOP);

		javax.swing.GroupLayout jPanelTopLayout = new javax.swing.GroupLayout(jPanelTop);
		jPanelTop.setLayout(jPanelTopLayout);
		jPanelTopLayout.setHorizontalGroup(
				jPanelTopLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanelTopLayout
						.createSequentialGroup().addContainerGap().addComponent(jLabel1).addContainerGap()));
		jPanelTopLayout
				.setVerticalGroup(jPanelTopLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelTopLayout.createSequentialGroup().addContainerGap().addComponent(jLabel1,
								javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap()));

		jButtonOpenOutputFolder.setIcon(new javax.swing.ImageIcon(
		...
		jButtonOpenPEXWebsite.setIcon(new javax.swing.ImageIcon(
				"C:\\Users\\Salva\\workspace\\miape-extractor\\src\\main\\resources\\pex.png")); // NOI18N
		jButtonOpenPEXWebsite.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		jPanelDownLayout
				.setHorizontalGroup(jPanelDownLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		jPanelDownLayout.setVerticalGroup(jPanelDownLayout
				...
				.addGroup(jPanelDownLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelDownLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jButtonOpenPEXWebsite).addComponent(jButtonOpenOutputFolder))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(jPanelTop, javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
						...
						.addComponent(jPanelTop, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jPanelDown,
	...
	private void jButtonOpenPEXWebsiteActionPerformed(java.awt.event.ActionEvent evt) {
		HttpUtilities.openURL(PEXWebsite);
	}

	private void jButtonOpenOutputFolderActionPerformed(java.awt.event.ActionEvent evt) {
		openOutputFolder();
	}
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				PEXSubmissionPreparedDialog dialog = new PEXSubmissionPreparedDialog(new javax.swing.JDialog(), true,
						new File("c:\\"));
