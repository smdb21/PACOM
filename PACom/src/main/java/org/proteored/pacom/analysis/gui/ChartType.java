											...
											PEPTIDE_OVERLAPING("Peptide overlapping",
													...
													PROTEIN_OCURRENCE_HEATMAP("Protein Heat Map",
															...
															PEPTIDE_OCCURRENCE_HEATMAP("Peptide Heat Map",
																	...
																	PEPTIDE_PRESENCY_HEATMAP(
																			"Peptide list ocurrence HeatMap",
																			...
																			PSMS_PER_PEPTIDE_HEATMAP(
																					"PSMs per peptide heatmap",
											...
											PROTEIN_COVERAGE("Average protein coverage",
													...
													PEPTIDE_CHARGE_HISTOGRAM("Peptide charge distribution",
															...
															SINGLE_HIT_PROTEINS("Single hit proteins",
																	...
																	PEPTIDE_NUMBER_IN_PROTEINS(
																			"Number of proteins with x peptides",
																			...
																			DELTA_MZ_OVER_MZ("Peptide mass error",
																					...
																					PSM_PEP_PROT(
																							...
																							FDR_VS_SCORE(
																									"FDRs vs Score & num. proteins vs Score",
																									...
																									EXCLUSIVE_PROTEIN_NUMBER(
																											"Number of exclusive proteins",
			...
			PSMS_PER_PROTEIN_HEATMAP("PSMs per protein heatmap",
					...
					PEPTIDE_NUM_PER_PROTEIN_MASS("Number of peptides / protein molecular weight",
							...
							HUMAN_CHROMOSOME_COVERAGE("Human chromosome coverage",
									"Bar graph ('show spider plot'=unchecked) or spider plot ('show spider plot'=checked) containing the number of Human genes per chromosome in each dataset. Activate <i>Normalize</i> to see the  percentage of the total Human genes in each chromosome that has been detected in each dataset. Activating the option 'One gene per protein group' will only consider one gene in each protein group."),
									// CHR16_MAPPING ( "Human chromosome 16
									// mapping
									// (SPanish-HPP)","",""),
	CHR_MAPPING("Proteins and genes per chromosome",
			"Bar graph ('Show as pie chart'=unchecked) or pie chart('Show as pie chart'=checked) containing the number of proteins encoded in each Human chromosome, or number of genes in each Human chromosome, (or both), per dataset. Try filter by Human taxonomy, or by an specific Human chromosome. To remove the filter, disable the Protein ACC filter."), //
															...
															SINGLE_RT_COMPARISON(
																	...
																	SPECTROMETERS("Spectrometers",
																			...
																			INPUT_PARAMETERS("Input parameters",
																					...
																					PEPTIDE_COUNTING_HISTOGRAM(
																							"Peptide counting ratio histogram",
																							...
																							PEPTIDE_COUNTING_VS_SCORE(
																									"Peptide counting ratio vs score",
