/*
 * Copyright 2010 Tom Castle (www.tc33.org) Licensed under GNU Lesser General Public License This
 * file is part of JHeatChart - the heat maps charting api for Java. JHeatChart is free software:
 * you can redistribute it and/or modify it under the terms of the GNU Lesser General Public License
 * as published by the Free Software Foundation, either version 3 of the License, or (at your
 * option) any later version. JHeatChart is distributed in the hope that it will be useful, but
 * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A
 * PARTICULAR PURPOSE. See the GNU General Public License for more details. You should have received
 * a copy of the GNU Lesser General Public License along with JHeatChart. If not, see
...
public class HeatChart {
	...
	private Font axisValuesFont; // The font size will be considered the maximum
									// font size - it may be smaller if needed
									// to fit in.
	 ...
	 *            the font to be used to define the visual style of the axis
	 *            labels.
	 */
	 ...
	 *            the frequency of the values displayed against columns, where 1
	...
	public boolean isShowXAxisValues() {
		// TODO Could get rid of these flags and use a frequency of -1 to signal
		// no values.
	 ...
	 *            true if x-axis values should be displayed, false if they
	 *            should be hidden.
	 */
	 ...
	 *            true if y-axis values should be displayed, false if they
	 *            should be hidden.
	 */
	...
	private void measureComponents() {
		// TODO This would be a good place to check that all settings have
