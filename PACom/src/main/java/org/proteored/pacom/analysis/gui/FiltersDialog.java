...
public class FiltersDialog extends javax.swing.JDialog implements PropertyChangeListener {
	...
	private void initComponents() {
		...
		jTextFieldOccurrenceThreshold.setColumns(3);
		...
		jComboBoxProteinOrPeptide
				.setModel(new javax.swing.DefaultComboBoxModel(IdentificationItemEnum.valuesWithNoPSMs()));
		...
		jPanelOccurrenceFilterLayout
				.setHorizontalGroup(jPanelOccurrenceFilterLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(jPanelOccurrenceFilterLayout.createSequentialGroup().addContainerGap()
								.addGroup(jPanelOccurrenceFilterLayout.createParallelGroup(Alignment.LEADING)
										.addComponent(jPanelOccurrenceParameters, GroupLayout.DEFAULT_SIZE, 760,
												Short.MAX_VALUE)
		...
		jPanelOccurrenceParameters.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		jPanelOccurrenceParameters.add(jLabel4);
		jPanelOccurrenceParameters.add(jComboBoxProteinOrPeptide);
		jPanelOccurrenceParameters.add(jLabel5);
		jPanelOccurrenceParameters.add(jTextFieldOccurrenceThreshold);
		jPanelOccurrenceParameters.add(jComboBoxReplicatesOrTimes);

		jLabel6 = new JLabel("at level");
		jLabel6.setEnabled(false);
		jPanelOccurrenceParameters.add(jLabel6);

		jComboBoxLevel = new JComboBox();
		jComboBoxLevel.setEnabled(false);
		jComboBoxLevel.setModel(new DefaultComboBoxModel(new String[] { "level 0", "level 1", "level 2" }));
		jPanelOccurrenceParameters.add(jComboBoxLevel);
		jPanelOccurrenceParameters.add(jCheckBoxDistinguishModPeptides);
