...
import org.proteored.pacom.analysis.exporters.tasks.PEXBulkSubmissionFileDownloaderTask;
 ...
 * @author __USER__
 */
public class PEXBulkSubmissionSummaryFileCreatorDialog extends javax.swing.JDialog implements PropertyChangeListener {
	...
	public PEXBulkSubmissionSummaryFileCreatorDialog(Frame parent, ExperimentList experimentList) {
		...
		jButtonAddRawDataFile.setIcon(ImageManager.getImageIcon(ImageManager.ADD));
	...
	private void cancelAllJobs() {
		...
		if (fileDownloaderTask != null && fileDownloaderTask.getState() == StateValue.STARTED) {
		...
		if (prideExporterTask != null && prideExporterTask.getState() == StateValue.STARTED) {
		...
		if (bulkSubmissionWriterTask != null && bulkSubmissionWriterTask.getState() == StateValue.STARTED) {
	...
	private void loadSummaryTree() {
		...
		treeloaderTask = new PEXBulkSubmissionSummaryTreeLoaderTask(experimentList, jTreeSummary,
				jCheckBoxIncludeMSIAttachedFiles.isSelected(), jCheckBoxIncludeMIAPEReports.isSelected());
	...
	private void initComponents() {
		...
		jTextFieldFolder.setToolTipText(
				"<html> All files required for the ProteomeXchange<br> submission will be located here</html>");
		...
		jCheckBoxIncludeMSIAttachedFiles.setText("Include resulting files from MIAPE MSIs");
		jCheckBoxIncludeMSIAttachedFiles.addMouseListener(new java.awt.event.MouseAdapter() {
			@Override
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				jCheckBoxIncludeMSIAttachedFilesMouseEntered(evt);
			}
		});
		jCheckBoxIncludeMSIAttachedFiles.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		jLabelShowMSIAttached.addMouseListener(new java.awt.event.MouseAdapter() {
			@Override
			public void mouseEntered(java.awt.event.MouseEvent evt) {
		...
		jCheckBoxIncludeMIAPEReports.setToolTipText(
		...
		jCheckBoxIncludeMIAPEReports.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxCompress).addComponent(jCheckBoxIncludeMIAPEReports))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxIncludeMSIAttachedFiles).addComponent(jLabelShowMSIAttached))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1).addComponent(jButtonSelectFolder).addComponent(jTextFieldFolder,
		...
		jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addComponent(jCheckBoxIncludeSpectra)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxExcludeNotMatchedSpectra)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxExcludeNonConclusiveProteins).addContainerGap(235, Short.MAX_VALUE)));
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup()
						.addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxIncludeSpectra).addComponent(jCheckBoxExcludeNotMatchedSpectra)
		...
		jTextFieldKeywords.setToolTipText(
				"<html>\nA list of keywords that describe the content and type of the<br>\nexperiment being submitted. Multiple entries should be comma<br>\nseparated, it is recommended to provide a minimum of three<br>\nkeywords.</html>");
						...
						.addGroup(jPanel5Layout.createSequentialGroup()
								...
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 626,
												Short.MAX_VALUE)
										.addComponent(jTextFieldTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 626,
												Short.MAX_VALUE)))
						.addGroup(jPanel5Layout.createSequentialGroup().addComponent(jLabel5)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jTextFieldPRIDELogin, javax.swing.GroupLayout.DEFAULT_SIZE, 597,
										Short.MAX_VALUE))
						.addGroup(jPanel5Layout.createSequentialGroup().addComponent(jLabel4)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jTextFieldKeywords, javax.swing.GroupLayout.DEFAULT_SIZE, 635,
										Short.MAX_VALUE)))
						.addContainerGap()));
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel5Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel2).addComponent(jTextFieldTitle,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel5).addComponent(jTextFieldPRIDELogin,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		jButtonAddRawDataFile.setIcon(new javax.swing.ImageIcon(
		...
		jButtonAddRawDataFile.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel7Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabelRawData, javax.swing.GroupLayout.PREFERRED_SIZE, 264,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jButtonAddRawDataFile))
						.addContainerGap()));
		jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel7Layout.createSequentialGroup().addContainerGap().addComponent(jButtonAddRawDataFile)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jLabelRawData, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		jButtonDeleteNode.setIcon(new javax.swing.ImageIcon(
		...
		jButtonDeleteNode.setToolTipText(
				"<html>Click here to remove the selected node in order to not<br> include it in the ProteomeXchange submission</html>");
		...
		jPanel9Layout.setHorizontalGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel9Layout.createSequentialGroup().addContainerGap().addComponent(jButtonDeleteNode)
						.addContainerGap(99, Short.MAX_VALUE)));
		jPanel9Layout.setVerticalGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel9Layout.createSequentialGroup().addComponent(jButtonDeleteNode)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		jPanelSummaryLayout
				.setHorizontalGroup(
						jPanelSummaryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelSummaryLayout.createSequentialGroup().addContainerGap()
										.addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 399,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSummaryLayout.createSequentialGroup()
						...
						.addGroup(jPanelSummaryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.LEADING,
										javax.swing.GroupLayout.PREFERRED_SIZE, 453,
										javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		jPanel8.setBorder(
				javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Action"));

		jButtonStartPEX.setIcon(new javax.swing.ImageIcon(
				"C:\\Users\\Salva\\workspace\\miape-extractor\\src\\main\\resources\\pex.png")); // NOI18N
		jButtonStartPEX.setToolTipText("Click here to prepare data for a ProteomeXchange submission");
		...
		jPanel8Layout.setHorizontalGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel8Layout.createSequentialGroup().addContainerGap().addComponent(jButtonStartPEX)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 453, Short.MAX_VALUE)
						.addComponent(jButtonCancel).addContainerGap()));
		jPanel8Layout.setVerticalGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel8Layout.createSequentialGroup()
						.addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jButtonStartPEX).addComponent(jButtonCancel))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 509,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	private void deleteSelectedNode() {
		...
		final boolean childrenOfReplicateNodeSelected = jTreeSummary.isOnlyOneNodeSelected(4);
		if (!rootNodeSelected && childrenOfReplicateNodeSelected) {
			// remove the file from the mappings
			String nodeString = (String) jTreeSummary.getSelectedNode().getUserObject();
			if (nodeString.startsWith(PEXBulkSubmissionSummaryTreeLoaderTask.RAW + ": ")) {
				nodeString = nodeString.split(PEXBulkSubmissionSummaryTreeLoaderTask.RAW + ": ")[1];
				final DefaultMutableTreeNode parent = (DefaultMutableTreeNode) jTreeSummary.getSelectedNode()
						.getParent();
	...
	private void jCheckBoxIncludeMIAPEReportsActionPerformed(java.awt.event.ActionEvent evt) {
		loadSummaryTree();
	}
	...
	private void jTreeSummaryMouseClicked(java.awt.event.MouseEvent evt) {
		final boolean replicateNodeSelected = jTreeSummary.isOnlyOneNodeSelected(3);
		// log.info(onlyOneNodeSelected);
		if (replicateNodeSelected) {
			jButtonAddRawDataFile.setEnabled(true);
			jLabelRawData.setText(
					"<html>Click on 'Add raw data file' to attach <br>" + "a RAW data file to the submission</html>");
		} else {
			jButtonAddRawDataFile.setEnabled(false);
			jLabelRawData.setText("");
		}
	...
	private void jCheckBoxIncludeMSIAttachedFilesActionPerformed(java.awt.event.ActionEvent evt) {
		loadSummaryTree();
	}

	private void jButtonAddRawDataFileActionPerformed(java.awt.event.ActionEvent evt) {
		final boolean replicateNodeSelected = jTreeSummary.isOnlyOneNodeSelected(3);
		if (!replicateNodeSelected)
			return;
		...
		if (selectedFile != null) {
			...
			if (selectedFile.exists()) {
				String name = FilenameUtils.getName(selectedFile.getAbsolutePath());
				// Add node to the tree in the correct position
				DefaultMutableTreeNode selectedNode = jTreeSummary.getSelectedNode();
				DefaultMutableTreeNode newNode = jTreeSummary
						.addNewNode(PEXBulkSubmissionSummaryTreeLoaderTask.RAW + ": " + name, selectedNode);

				jTreeSummary.scrollToNode(newNode);
				// Add the raw file to the RAW file Map
				Replicate rep = (Replicate) selectedNode.getUserObject();
				if (PEXBulkSubmissionSummaryFileCreatorDialog.rawFileMapByReplicate.containsKey(rep)) {
					PEXBulkSubmissionSummaryFileCreatorDialog.rawFileMapByReplicate.get(rep).add(selectedFile);
				} else {
					List<File> fileList = new ArrayList<File>();
					fileList.add(selectedFile);
					PEXBulkSubmissionSummaryFileCreatorDialog.rawFileMapByReplicate.put(rep, fileList);
				}
				rawDataPresent = true;
			} else {
				appendStatus("File not found: " + selectedFile.getAbsolutePath());
			}
		}

	}

	private void jCheckBoxIncludeMSIAttachedFilesMouseEntered(java.awt.event.MouseEvent evt) {
		...
		if (experimentList != null) {
			...
			for (MiapeMSIDocument miapeMSIDocument : miapeMSIs) {
				if (miapeMSIDocument.getAttachedFileLocation() != null
						&& !"".equals(miapeMSIDocument.getAttachedFileLocation())) {
					try {
						URL url = new URL(miapeMSIDocument.getAttachedFileLocation());
						locations.add(miapeMSIDocument.getAttachedFileLocation());
	...
	private void startPEXBulkFileExportation() {
		...
		try {
			...
			pexFile = new ProteomeXchangeFilev2_1(outputFolder, experimentList, filesToSkip);
			...
			// file
			if (!PEXBulkSubmissionSummaryFileCreatorDialog.rawFileMapByReplicate.isEmpty()) {
				for (Replicate replicate : PEXBulkSubmissionSummaryFileCreatorDialog.rawFileMapByReplicate.keySet()) {
					List<File> files = PEXBulkSubmissionSummaryFileCreatorDialog.rawFileMapByReplicate.get(replicate);
					if (files != null && !files.isEmpty())
						pexFile.addReplicateRawFiles(replicate, files);
				}
			}
			fileDownloaderTask = new PEXBulkSubmissionFileDownloaderTask(pexFile, includeMSIAttachedFiles(),
					includeMIAPEReports(), compressDownloadedData());
	...
	private String getDescription() {
		...
		throw new IllegalMiapeArgumentException("A short description for the project is required");
	}
	...
	private String getProjectTitle() {
		...
		throw new IllegalMiapeArgumentException("A title for the project is required");
	}
	...
	private Set<String> getKeywords() {
		...
		if (!"".equals(keywordsText)) {
			...
			if (keywordsText.contains(",")) {
				...
				throw new IllegalMiapeArgumentException("At least three keywords are required (separated by commas)");
			}
			if (ret.size() >= 3)
				return ret;
			else
		...
		throw new IllegalMiapeArgumentException("No Keywords have been instroduced");
	}
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (evt.getPropertyName().equals(PRIDEExporterTask.SINGLE_PRIDE_EXPORTING_STARTED)) {
			...
			if (generatedFile != null && generatedFile.exists()) {
				appendStatus("PRIDE XML file created: " + FilenameUtils.getName(generatedFile.getAbsolutePath()) + " ("
			...
			if (generatedFile != null && generatedFile.exists()) {
				appendStatus("PRIDE XML file already present in output folder: "
						+ FilenameUtils.getName(generatedFile.getAbsolutePath()) + " ("
						+ getFileSizeString(generatedFile) + ")");
				appendStatus(
						"PRIDE XML creation will be skipped since there is already a file in the output folder with the name '"
								+ FilenameUtils.getName(generatedFile.getAbsolutePath()) + "'");
				numCreated++;
				jProgressBar.setString(getProgressString());
			...
			if (fileToCompress != null && fileToCompress.exists()) {
				appendStatus("Compressing PRIDE XML file: " + FilenameUtils.getName(fileToCompress.getAbsolutePath())
			...
			if (generatedFiles != null && !generatedFiles.isEmpty()) {
				...
				if (generatedFiles.size() > 1)
					plural = "s";
				String message = generatedFiles.size() + " PRIDE XML file" + plural + " generated at '"
				...
				bulkSubmissionWriterTask = new PEXBulkSubmissionFileWriterTask(pexFile);
		...
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_DOWNLOADING_STARTED)) {
			jButtonStartPEX.setEnabled(false);
		...
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_DOWNLOADED)) {
			File downloadedFile = (File) evt.getNewValue();
			appendStatus("File downloaded: " + FilenameUtils.getName(downloadedFile.getAbsolutePath()) + " ("
					+ getFileSizeString(downloadedFile) + ")");
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_FOUND_IN_OUTPUT_FOLDER)) {
			File downloadedFile = (File) evt.getNewValue();
			appendStatus(
					"File already found in output folder: " + FilenameUtils.getName(downloadedFile.getAbsolutePath()));
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_DOWNLOADING_FINISH)) {
			jButtonStartPEX.setEnabled(true);
			...
			prideExporterTask = new PRIDEExporterTask(experimentList, getOutputFolder(),
					jCheckBoxIncludeSpectra.isSelected(), jCheckBoxExcludeNotMatchedSpectra.isSelected(),
					jCheckBoxCompress.isSelected(), jCheckBoxExcludeNonConclusiveProteins.isSelected());
			prideExporterTask.addPropertyChangeListener(this);
			prideExporterTask.execute();

		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_DOWNLOADING_ERROR)) {
			jButtonStartPEX.setEnabled(true);
			String message = (String) evt.getNewValue();
			appendStatus(message);

		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileWriterTask.PEX_EXPORT_STARTED)) {
			appendStatus("Writting ProteomeXchange bulk submission file");
			jProgressBar.setString("Step 3/3: Writting ProteomeXchange Bulk Submission Summary file");
			jProgressBar.setStringPainted(true);
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileWriterTask.PEX_EXPORT_FINISH)) {
			...
			if (pexFile != null) {
				...
				jProgressBar.setString("ProteomeXchange Bulk Submission Summary file created");
				jButtonCancel.setEnabled(false);
				long tFinal = System.currentTimeMillis();
				appendStatus("It took " + getFormatedTime((tFinal - tBegin) / 1000.0));
				showFinishDialog();
			}
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileWriterTask.PEX_EXPORT_ERROR)) {
			appendStatus("Error when writting ProteomeXchange bulk submission file: " + evt.getNewValue());
			jProgressBar.setStringPainted(true);
			jButtonCancel.setEnabled(false);

		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_COMPRESSION_STARTED)) {
			File filetoCompress = (File) evt.getNewValue();
			appendStatus("Compressing file: " + filetoCompress.getAbsolutePath());
		} else if (evt.getPropertyName().equals(PEXBulkSubmissionFileDownloaderTask.PEX_FILE_COMPRESSION_FINISHED)) {
			File fileCompressed = (File) evt.getNewValue();
			appendStatus("File compressed at: " + fileCompressed.getAbsolutePath());
	...
	private void showFinishDialog() {
		PEXSubmissionPreparedDialog dialog = new PEXSubmissionPreparedDialog(this, true, pexFile.getOutputFolder());
		dialog.setVisible(true);
	}
