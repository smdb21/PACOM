...
import org.proteored.miapeExtractor.analysis.charts.CombinedChart;
...
import org.proteored.miapeExtractor.analysis.charts.LineCategoryChart;
import org.proteored.miapeExtractor.analysis.charts.PieChart;
import org.proteored.miapeExtractor.analysis.charts.SpiderChart;
import org.proteored.miapeExtractor.analysis.charts.StackedBarChart;
import org.proteored.miapeExtractor.analysis.charts.TableData;
...
import org.proteored.miapeExtractor.analysis.charts.XYLineChart;
import org.proteored.miapeExtractor.analysis.charts.XYPointChart;
import org.proteored.miapeExtractor.analysis.gui.AdditionalOptionsPanelFactory;
...
public class ChartCreatorTask extends SwingWorker<Object, Void> {
	...
	private Object showPeptidePerProteinMassChart() {
		parent.setInformation1(parent.getCurrentChartType());
		int bins = optionsFactory.getHistogramBins();
		HistogramType histogramType = optionsFactory.getHistogramType();
		String xAxisLabel;
		...
		if (ChartManagerFrame.ONE_SERIES_PER_REPLICATE.equals(this.option)) {
			...
			for (Experiment identificationSet : experiments) {
				...
				if (idSetsCheckBoxes != null) {
					...
					log.info("EXP=" + experiment.getFullName());
					idSets.add(experiment);
				}
			}
			if (addParentLevelIdSet)
